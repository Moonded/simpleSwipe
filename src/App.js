      ...
      <div>
        ...
        <div className="w-full bottom-0  absolute overflow-auto bg-black">
          <div id="swipe_container" className="h-40 relative overflow-hidden">
            <div
              id="swipeBar"
              className="flex items-center justify-center bg-[#351717]"
            >
              <div className="mt-1.5 bg-white h-1 w-20" />
            </div>
            <div id="content" className="relative top-0">
              <div className="flex justify-center mt-2">
                Put your Mobile Nav Content here!
              </div>
            </div>
          </div>
        </div>
